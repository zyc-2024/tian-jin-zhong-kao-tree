var systemComponents = {
    ...
    'options-tab': {
        ...
        <table>
			...
			<td><button class="opt" onclick="setBuyableAmount('Nf',12,getBuyableAmount('Nf',12).gte(1)? new OmegaNum(0) : new OmegaNum(1))">计数法：{{ getBuyableAmount('Nf',12).gte(1)?"科学计数法":"中文计数法" }}</button></td>
			<td><button class="opt" onclick="">Place Holder</button></td>
			</tr> 
        </table>`
